            ...
            <div className="w-full mx-auto">
                <AnimatedSection>
                    <div className="text-center mb-16">
                        <h2 className="font-heading text-4xl md:text-5xl font-bold mb-4 text-slate-900 dark:text-white">Technology Stack</h2>
                            ...
                            <div key={index} className="px-4 flex-shrink-0 w-[300px] md:w-[350px]">
                                <div className="bg-slate-50 dark:bg-slate-800/50 backdrop-blur-sm p-8 rounded-3xl border border-slate-200 dark:border-slate-700 hover:border-cyan-500/50 hover:bg-white dark:hover:bg-slate-800 transition-all duration-300 group h-full shadow-sm hover:shadow-xl">
                                    <div className="flex items-center gap-4 mb-6">
                                        ...
                                        <h3 className="font-display text-xl font-extrabold text-slate-900 dark:text-white">{tech.category}</h3>
                                    </div>
                                    <ul className="space-y-4">
                                        {tech.items.map((item, idx) => (
                                            <li key={idx} className="flex items-center font-body text-slate-600 dark:text-slate-300 font-medium group-hover:text-slate-900 dark:group-hover:text-slate-100 transition-colors">
